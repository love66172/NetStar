var NetstarComponentEditor = (function($){
	...
	var formConfig = {
		...
		valuesInput : ['format'],
		upload : ['textField','valueField','isMultiple','accept','urlField','thumUrlField','isShowThum','fileTypeField','fileType','btns', 'visibilityLevel','outputFields','innerFields','produceFileAjax-ajax'],
