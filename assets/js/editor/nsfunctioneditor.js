var nsFuncEditor = (function($){
	...
	var basePanelFormArrList = {
		...
		multiDialog:['englishName','chineseName','defaultMode','functionClass','isCloseWindow','type','dataSrc','dataLevel','text','title','suffix',"requestSource","isMainDbAction",'isAlwaysNewTab','isEditMode','isInlineBtn','isMobileInlineBtn','disabledExpression','parameterFormatType','parameterFormat','validateParams','matrixVariable','isSendPageParams','formatValueData','shortcutKey','isKeepSelected','tabTitles','isSetValueToSourcePage',"targetField"],		
		...
		tel:['englishName','chineseName','defaultMode','functionClass','text','sourceField','parameterFormatType','parameterFormat','validateParams','matrixVariable','isSendPageParams','shortcutKey','isKeepSelected','isSetValueToSourcePage',"targetField",'isInlineBtn'],
		email:['englishName','chineseName','defaultMode','functionClass','text','sourceField','parameterFormatType','parameterFormat','validateParams','matrixVariable','isSendPageParams','shortcutKey','isKeepSelected','isSetValueToSourcePage',"targetField"],
		...
		excelImportVer2:['englishName','chineseName','defaultMode','functionClass','isCloseWindow','type','text','title',"requestSource","templateId",'shortcutKey','isKeepSelected','isSetValueToSourcePage',"targetField"],
		ajaxAndSend:['englishName','chineseName','defaultMode','functionClass','type','dataSrc','text','ajaxData','webSocketBody',"targetField",'callbackAjax','requestSource'],
		business : ['englishName','chineseName','defaultMode','functionClass','suffix','dataSrc','type','contentType','text','ajaxData','dialogTitle','selectMode',"requestSource","targetField","operatorMode",'getPanelDataAjax-suffix','getPanelDataAjax-dataSrc','getPanelDataAjax-type','getPanelDataAjax-contentType','getPanelDataAjax-data'],
		previewFile : ['englishName','chineseName','defaultMode','functionClass','suffix','dataSrc','type','contentType','text','ajaxData',"requestSource",'fileFields'],
	}
	var addFormArrList = {
		...
		tel:['englishName','chineseName','defaultMode','functionClass','voId','text','sourceField','parameterFormat','validateParams','matrixVariable','isSendPageParams','shortcutKey','isKeepSelected','isSetValueToSourcePage',"targetField",'isInlineBtn'],
		email:['englishName','chineseName','defaultMode','functionClass','voId','text','sourceField','parameterFormat','validateParams','matrixVariable','isSendPageParams','shortcutKey','isKeepSelected','isSetValueToSourcePage',"targetField"],
		...
		excelImportVer2:['englishName','chineseName','defaultMode','functionClass','voId','isCloseWindow','type','text','title',"requestSource","templateId",'shortcutKey','isKeepSelected','isSetValueToSourcePage',"targetField"],
		ajaxAndSend:['englishName','chineseName','defaultMode','functionClass','voId','suffix','dataSrc','type','contentType','text','ajaxData','webSocketBody',"targetField",'callbackAjax','requestSource'],
		business : ['englishName','chineseName','defaultMode','functionClass','voId','suffix','dataSrc','type','contentType','text','ajaxData','dialogTitle','selectMode',"requestSource","targetField","operatorMode",'getPanelDataAjax-suffix','getPanelDataAjax-dataSrc','getPanelDataAjax-type','getPanelDataAjax-contentType','getPanelDataAjax-data',"targetField"],
		previewFile : ['englishName','chineseName','defaultMode','functionClass','voId','suffix','dataSrc','type','contentType','text','ajaxData',"requestSource",'fileFields'],
	};
	// 编辑器整体框架
	var container = {
		// 预览数据
		...
		getSaveData:function(){
			...
			if(sourceData){
				...
				if(config.isAdd){
					...
					if(editorData.defaultMode !== "ajaxAndSend"){
